...
------------------------------------------------------------------
  AGENT-README.txt
      FreePPlus.LgplLicenseForever — reads and writes Excel .xlsx/.xlsm files
      using the Office Open XML format, with no dependency on Excel or COM
      interop.
