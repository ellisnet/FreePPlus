...
*/
    ...
    internal ExcelSparklineGroup(XmlNamespaceManager ns, XmlElement topNode, ExcelWorksheet ws) : base(ns, topNode)
    {
        SchemaNodeOrder = new[]
        {
            "colorSeries", "colorNegative", "colorAxis", "colorMarkers", "colorFirst", "colorLast", "colorHigh",
    ...
    public ExcelRangeBase DateAxisRange
    {
        get
        {
            ...
            if (a.WorkSheet.Equals(_ws.Name, StringComparison.CurrentCultureIgnoreCase)) return _ws.Cells[a.Address];
    ...
    public ExcelRangeBase DataRange
    {
        get
        {
            if (Sparklines.Count == 0) return null;

            var ws = _ws.Workbook.Worksheets[Sparklines[0].RangeAddress.WorkSheet];
            return _ws.Cells[Sparklines[0].RangeAddress._fromRow, Sparklines[0].RangeAddress._fromCol,
                Sparklines[Sparklines.Count - 1].RangeAddress._toRow,
                Sparklines[Sparklines.Count - 1].RangeAddress._toCol];
        }
    }
    ...
    public ExcelRangeBase LocationRange
    {
        get
        {
            if (Sparklines.Count == 0)
                return null;
            return _ws.Cells[Sparklines[0].Cell.Row, Sparklines[0].Cell.Column,
                Sparklines[Sparklines.Count - 1].Cell.Row, Sparklines[Sparklines.Count - 1].Cell.Column];
        }
    }
    ...
    public ExcelSparklineColor ColorSeries
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorSeriesPath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorNegative
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorNegativePath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorAxis
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorAxisPath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorMarkers
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorMarkersPath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorFirst
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorFirstPath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorLast
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorLastPath, NameSpaceManager));
        }
    }
    ...
    public ExcelSparklineColor ColorHigh
    {
        get
        {
            ...
            return new ExcelSparklineColor(NameSpaceManager,
                TopNode.SelectSingleNode(_colorHighPath, NameSpaceManager));
        }
    }
