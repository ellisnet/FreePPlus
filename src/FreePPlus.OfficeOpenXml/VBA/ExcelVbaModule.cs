...
{
    private readonly ModuleNameChange _nameChangeCallback;
    ...
    public string Name
    {
        ...
        set
        {
            ...
            if (value != _name)
            {
                _name = value;
                streamName = value;
                if (_nameChangeCallback != null) _nameChangeCallback(value);
            }
        }
    }
        ...
        set
        {
            if (value.StartsWith("Attribute", StringComparison.OrdinalIgnoreCase) ||
                ...
                throw new InvalidOperationException(
                    "Code can't start with an Attribute or VERSION keyword. Attributes can be accessed through the Attributes collection.");
            _code = value;
        }
    }
