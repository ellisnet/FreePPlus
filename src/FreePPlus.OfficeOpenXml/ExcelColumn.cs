...
public class ExcelColumn : IRangeID
{
    ...
    public int ColumnMax
    {
        ...
        set
        {
            if (value < _columnMin && value > ExcelPackage.MaxColumns) throw new Exception("ColumnMax out of range");
    ...
    {
        return string.Format("Column Range: {0} to {1}", _colElement.GetAttribute("min"),
    ...
    public double Width
    {
        ...
        set
        {
            ...
            if (_hidden && value != 0) _hidden = false;
        }
    }
