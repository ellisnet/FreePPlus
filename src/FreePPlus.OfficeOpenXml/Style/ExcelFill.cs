...
public class ExcelFill : StyleBase
{
    ...
    internal ExcelFill(ExcelStyles styles, XmlHelper.ChangedEventHandler ChangedEvent, int PositionID, string address,
        int index) :
    ...
    public ExcelFillStyle PatternType
    {
        ...
        set
        {
            ...
            _ChangedEvent(this,
                new StyleChangeEventArgs(eStyleClass.Fill, eStyleProperty.PatternType, value, _positionID, _address));
        }
    }
    ...
    public ExcelColor PatternColor
    {
        get
        {
            ...
            {
                _patternColor = new ExcelColor(_styles, _ChangedEvent, _positionID, _address,
                    eStyleClass.FillPatternColor, this);
                if (_gradient != null) _gradient = null;
            }
    ...
    public ExcelColor BackgroundColor
    {
        get
        {
            ...
            {
                _backgroundColor = new ExcelColor(_styles, _ChangedEvent, _positionID, _address,
                    eStyleClass.FillBackgroundColor, this);
                if (_gradient != null) _gradient = null;
            }
