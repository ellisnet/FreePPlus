...
public sealed class ExcelColor : StyleBase, IColor
{
    ...
    internal ExcelColor(ExcelStyles styles, XmlHelper.ChangedEventHandler ChangedEvent, int worksheetID, string address,
        eStyleClass cls, StyleBase parent) :
    ...
    public decimal Tint
    {
        ...
        set
        {
            if (value > 1 || value < -1) throw new ArgumentOutOfRangeException("Value must be between -1 and 1");
    ...
    {
        get => GetSource().Rgb;
        internal set => _ChangedEvent(this,
            new StyleChangeEventArgs(_cls, eStyleProperty.Color, value, _positionID, _address));
    }
    ...
    public int Indexed
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(_cls, eStyleProperty.IndexedColor, value, _positionID, _address));
    }
