...
public sealed class ExcelStyle : StyleBase
{
    ...
    internal ExcelStyle(ExcelStyles styles, XmlHelper.ChangedEventHandler ChangedEvent, int positionID, string Address,
        int xfsId) :
    ...
    public ExcelHorizontalAlignment HorizontalAlignment
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.HorizontalAlign, value, _positionID, _address));
    }
    ...
    public ExcelVerticalAlignment VerticalAlignment
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.VerticalAlign, value, _positionID, _address));
    }
    ...
    public bool WrapText
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.WrapText, value, _positionID, _address));
    }
    ...
    public ExcelReadingOrder ReadingOrder
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.ReadingOrder, value, _positionID, _address));
    }
    ...
    public bool ShrinkToFit
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.ShrinkToFit, value, _positionID, _address));
    }
    ...
    public int Indent
    {
        ...
        set
        {
            if (value < 0 || value > 250) throw new ArgumentOutOfRangeException("Indent must be between 0 and 250");
            _ChangedEvent(this,
                new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.Indent, value, _positionID, _address));
        }
    }
    ...
    public int TextRotation
    {
        ...
        set
        {
            if (value < 0 || value > 180) throw new ArgumentOutOfRangeException("TextRotation out of range.");
            _ChangedEvent(this,
                new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.TextRotation, value, _positionID, _address));
        }
    }
    ...
    public bool Locked
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.Locked, value, _positionID, _address));
    }
    ...
    public bool Hidden
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.Hidden, value, _positionID, _address));
    }
    ...
    public bool QuotePrefix
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.QuotePrefix, value, _positionID, _address));
    }
    ...
    public int XfId
    {
        ...
        set => _ChangedEvent(this,
            new StyleChangeEventArgs(eStyleClass.Style, eStyleProperty.XfId, value, _positionID, _address));
    }
    ...
    internal override string Id => Numberformat.Id + "|" + Font.Id + "|" + Fill.Id + "|" + Border.Id + "|" +
