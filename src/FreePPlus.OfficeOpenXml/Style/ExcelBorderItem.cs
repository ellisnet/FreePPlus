...
public sealed class ExcelBorderItem : StyleBase
{
    ...
    internal ExcelBorderItem(ExcelStyles styles, XmlHelper.ChangedEventHandler ChangedEvent, int worksheetID,
        string address, eStyleClass cls, StyleBase parent) :
    ...
    public ExcelColor Color
    {
        get
        {
            if (_color == null) _color = new ExcelColor(_styles, _ChangedEvent, _positionID, _address, _cls, _parent);
            return _color;
        }
    }
