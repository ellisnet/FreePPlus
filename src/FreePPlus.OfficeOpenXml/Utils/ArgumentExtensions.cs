...
public static class ArgumentExtensions
{
        ...
        where T : class
    {
        ...
        if (argument.Value == null) throw new ArgumentNullException(argumentName);
    }
    ...
    {
        if (string.IsNullOrEmpty(argument.Value)) throw new ArgumentNullException(argumentName);
    }
