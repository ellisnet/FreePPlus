...
internal partial class ZipEntry
{
    ...
    public string Info
    {
        get
        {
            ...
            if (!string.IsNullOrEmpty(_Comment)) builder.Append(string.Format("           Comment: {0}\n", _Comment));
            builder.Append("\n");
        ...
        Dictionary<string, object> previouslySeen)
    {
        ...
        if (IsNotValidZipDirEntrySig(signature))
        {
            ...
            if (signature != ZipConstants.EndOfCentralDirectorySignature &&
                ...
                throw new BadReadException(string.Format("  Bad signature (0x{0:X8}) at position 0x{1:X8}", signature,
                    s.Position));
            return null;
        }
