...
public sealed class ExcelDrawingFill : XmlHelper
{
        ...
        base(nameSpaceManager, topNode)
    {
        ...
        SchemaNodeOrder = new[]
        {
            "tickLblPos", "spPr", "txPr", "dLblPos", "crossAx", "printSettings", "showVal", "prstGeom", "noFill",
            "solidFill", "blipFill", "gradFill", "noFill", "pattFill", "ln", "prstDash"
        };
        //Setfill node
        if (_fillNode != null)
        {
    ...
    public Color Color
    {
        ...
        set
        {
            ...
            else if (_style != eFillStyle.SolidFill) throw new Exception("FillStyle must be set to SolidFill");
            ...
            SetXmlNodeString(_fillPath + ColorPath, value.ToArgbInt32().ToString("X8")[2..]);
        }
    }
