...
public sealed class ExcelView3D : XmlHelper
{
    ...
    public int DepthPercent
    {
        ...
        set
        {
            if (value < 0 || value > 2000) throw new ArgumentOutOfRangeException("Value must be between 0 and 2000");
    ...
    public int HeightPercent
    {
        ...
        set
        {
            if (value < 5 || value > 500) throw new ArgumentOutOfRangeException("Value must be between 5 and 500");
