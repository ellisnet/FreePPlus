...
public sealed class ExcelDrawingBorder : XmlHelper
{
        ...
        base(nameSpaceManager, topNode)
    {
        SchemaNodeOrder = new[]
        {
            "chart", "tickLblPos", "spPr", "txPr", "crossAx", "printSettings", "showVal", "showCatName", "showSerName",
            "showPercent", "separator", "showLeaderLines", "noFill", "solidFill", "blipFill", "gradFill", "noFill",
            "pattFill", "prstDash"
        };
        _linePath = linePath;
    ...
    public ExcelDrawingFill Fill
    {
        get
        {
            if (_fill == null) _fill = new ExcelDrawingFill(NameSpaceManager, TopNode, _linePath);
            return _fill;
        }
    }
    ...
    private string TranslateLineStyleText(eLineStyle value)
    {
        ...
        switch (value)
        {
            ...
            case eLineStyle.Solid:
                return text[..1].ToLower(CultureInfo.InvariantCulture) +
                       text.Substring(1, text.Length - 1); //First to Lower case.
