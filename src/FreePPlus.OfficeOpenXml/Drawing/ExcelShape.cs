...
namespace OfficeOpenXml.Drawing
{
    ...
    public sealed class ExcelShape : ExcelDrawing
    {
            ...
            base(drawings, node, "xdr:sp/xdr:nvSpPr/xdr:cNvPr/@name")
        {
            ...
            node.AppendChild(
                shapeNode.OwnerDocument.CreateElement("xdr", "clientData", ExcelPackage.SchemaSheetDrawings));
        }
        ...
        {
            SchemaNodeOrder = new[]
                { "prstGeom", "ln", "pPr", "defRPr", "solidFill", "uFill", "latin", "cs", "r", "rPr", "t" };
        }
        ...
        private string ShapeStartXml()
        {
            ...
            xml.AppendFormat(
                "<xdr:nvSpPr><xdr:cNvPr id=\"{0}\" name=\"{1}\" /><xdr:cNvSpPr /></xdr:nvSpPr><xdr:spPr><a:prstGeom prst=\"rect\"><a:avLst /></a:prstGeom></xdr:spPr><xdr:style><a:lnRef idx=\"2\"><a:schemeClr val=\"accent1\"><a:shade val=\"50000\" /></a:schemeClr></a:lnRef><a:fillRef idx=\"1\"><a:schemeClr val=\"accent1\" /></a:fillRef><a:effectRef idx=\"0\"><a:schemeClr val=\"accent1\" /></a:effectRef><a:fontRef idx=\"minor\"><a:schemeClr val=\"lt1\" /></a:fontRef></xdr:style><xdr:txBody><a:bodyPr vertOverflow=\"clip\" rtlCol=\"0\" anchor=\"ctr\" /><a:lstStyle /><a:p></a:p></xdr:txBody>",
                _id, Name);
            return xml.ToString();
        }
        ...
        public ExcelDrawingFill Fill
        {
            get
            {
                if (_fill == null) _fill = new ExcelDrawingFill(NameSpaceManager, TopNode, "xdr:sp/xdr:spPr");
                return _fill;
            }
        }
        ...
        public ExcelDrawingLineEnd LineEnds
        {
            get
            {
                if (_ends == null) _ends = new ExcelDrawingLineEnd(NameSpaceManager, TopNode, "xdr:sp/xdr:spPr/a:ln");
                return _ends;
            }
        }

        private readonly string[] paragraphNodeOrder =
            { "pPr", "defRPr", "solidFill", "uFill", "latin", "cs", "r", "rPr", "t" };
        ...
        public ExcelTextFont Font
        {
            get
            {
                if (_font == null)
                {
                    ...
                    _font = new ExcelTextFont(NameSpaceManager, TopNode, "xdr:sp/xdr:txBody/a:p/a:pPr/a:defRPr",
                        paragraphNodeOrder);
                }
        ...
        public ExcelParagraphCollection RichText
        {
            get
            {
                if (_richText == null)
                    ...
                    //}
                    _richText = new ExcelParagraphCollection(NameSpaceManager, TopNode, PARAGRAPH_PATH,
                        paragraphNodeOrder);
                return _richText;
            }
        }
