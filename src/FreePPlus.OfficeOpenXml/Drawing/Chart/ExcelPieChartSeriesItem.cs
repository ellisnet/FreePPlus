...
/// <summary>
///     A series item for a pie chart
/// </summary>
public sealed class ExcelPieChartSeriesItem : ExcelChartSeriesItem
{
    ...
    internal ExcelPieChartSeriesItem(ExcelChartSeries chartSeries, XmlNamespaceManager ns, XmlNode node, bool isPivot) :
    ...
    public int Explosion
    {
        ...
        set
        {
            if (value < 0 || value > 400)
                throw new ArgumentOutOfRangeException(nameof(value), "Explosion range is 0-400");
