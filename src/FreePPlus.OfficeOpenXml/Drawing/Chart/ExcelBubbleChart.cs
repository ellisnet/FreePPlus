...
public sealed class ExcelBubbleChart : ExcelChart
{
    ...
    internal ExcelBubbleChart(ExcelDrawings drawings, XmlNode node, eChartType type, ExcelChart topChart,
        ...
        base(drawings, node, type, topChart, PivotTableSource)
    {
        ...
        BubbleScale = 100;
        _chartSeries =
            new ExcelBubbleChartSeries(this, drawings.NameSpaceManager, _chartNode, PivotTableSource != null);
        //SetTypeProperties();
    }
    ...
    internal ExcelBubbleChart(ExcelDrawings drawings, XmlNode node, Uri uriChart, ZipPackagePart part,
    ...
    /// <summary>
    ///     Specifies the scale factor for the bubble chart. Can range from 0 to 300, corresponding to a percentage of the
    ///     default size,
    /// </summary>
