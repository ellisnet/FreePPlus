...
public class ExcelChartDataTable : XmlHelper
{
        ...
        : base(ns, node)
    {
        ...
        if (topNode == null)
        {
            ...
            SchemaNodeOrder = new[]
                { "dTable", "showHorzBorder", "showVertBorder", "showOutline", "showKeys", "spPr", "txPr" };
            topNode.InnerXml =
                "<c:showHorzBorder val=\"1\"/><c:showVertBorder val=\"1\"/><c:showOutline val=\"1\"/><c:showKeys val=\"1\"/>";
        }
    ...
    private readonly string[] _paragraphSchemaOrder =
    {
        "spPr", "txPr", "dLblPos", "showVal", "showCatName", "showSerName", "showPercent", "separator",
        "showLeaderLines", "pPr", "defRPr", "solidFill", "uFill", "latin", "cs", "r", "rPr", "t"
    };
