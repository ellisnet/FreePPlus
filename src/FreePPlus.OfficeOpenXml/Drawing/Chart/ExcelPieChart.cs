...
public class ExcelPieChart : ExcelChart
{
    ...
    internal ExcelPieChart(ExcelDrawings drawings, XmlNode node, Uri uriChart, ZipPackagePart part,
    ...
    internal override eChartType GetChartType(string name)
    {
        if (name == "pieChart")
        {
            if (Series.Count > 0 && ((ExcelPieChartSeriesItem)Series[0]).Explosion > 0)
