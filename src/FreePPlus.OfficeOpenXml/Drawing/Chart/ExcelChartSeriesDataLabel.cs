...
/// </summary>
public sealed class ExcelChartSeriesDataLabel : ExcelChartDataLabel
{
    ...
    internal ExcelChartSeriesDataLabel(XmlNamespaceManager ns, XmlNode node)
        : base(ns, node)
    {
        ...
        get
        {
            if (_font == null)
            {
                ...
                _font = new ExcelTextFont(NameSpaceManager, TopNode, "c:txPr/a:p/a:pPr/a:defRPr",
                    new[]
                    {
                        "spPr", "txPr", "dLblPos", "showVal", "showCatName ", "pPr", "defRPr", "solidFill", "uFill",
                        "latin", "cs", "r", "rPr", "t"
                    });
            }
