...
public sealed class ExcelScatterChart : ExcelChart
{
    ...
    internal ExcelScatterChart(ExcelDrawings drawings, XmlNode node, Uri uriChart, ZipPackagePart part,
    ...
    internal override eChartType GetChartType(string name)
    {
        if (name == "scatterChart")
        {
            ...
            {
                if (((ExcelScatterChartSeriesItem)Series[0]).Marker == eMarkerStyle.None)
