...
public class ExcelRadarChart : ExcelChart
{
    ...
    public ExcelChartDataLabel DataLabel
    {
        get
        {
            if (_DataLabel == null) _DataLabel = new ExcelChartDataLabel(NameSpaceManager, ChartNode);
            return _DataLabel;
        }
    }
    ...
    internal ExcelRadarChart(ExcelDrawings drawings, XmlNode node, Uri uriChart, ZipPackagePart part,
    ...
    internal ExcelRadarChart(ExcelDrawings drawings, XmlNode node, eChartType type, ExcelChart topChart,
