...
public class ExcelChartTitle : XmlHelper
{
        ...
        base(nameSpaceManager, node)
    {
        ...
        if (topNode == null)
        {
            ...
            topNode.InnerXml =
                "<c:tx><c:rich><a:bodyPr /><a:lstStyle /><a:p><a:pPr><a:defRPr sz=\"1800\" b=\"0\" /></a:pPr><a:r><a:t /></a:r></a:p></c:rich></c:tx><c:layout /><c:overlay val=\"0\" />";
        }
    ...
    public ExcelTextFont Font
    {
        get
        {
            ...
            //}
            //return _font;
            if (_richText == null || _richText.Count == 0) RichText.Add("");
            return _richText[0];
        }
    }
    ...
    public ExcelParagraphCollection RichText
    {
        ...
        {
            if (_richText == null)
                _richText = new ExcelParagraphCollection(NameSpaceManager, TopNode, "c:tx/c:rich/a:p",
                    paragraphNodeOrder);
            return _richText;
        }
    }
    ...
    ///     The way it works fundamentally is to determine the smallest possible "bounds box" for the text and then to center
    ///     that "bounds box" accordingly.
    ...
    public double Rotation
    {
        ...
        {
            int v;
            if (value < 0 || value > 360) throw new ArgumentOutOfRangeException("Rotation must be between 0 and 360");
