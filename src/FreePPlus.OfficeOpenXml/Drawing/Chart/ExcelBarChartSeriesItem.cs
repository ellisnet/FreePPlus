...
/// </summary>
public sealed class ExcelBarChartSeriesItem : ExcelChartSeriesItem
{
    ...
    internal ExcelBarChartSeriesItem(ExcelChartSeries chartSeries, XmlNamespaceManager ns, XmlNode node, bool isPivot) :
