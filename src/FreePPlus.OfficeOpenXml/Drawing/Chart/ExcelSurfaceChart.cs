...
public sealed class ExcelSurfaceChart : ExcelChart
{
    ...
    internal ExcelSurfaceChart(ExcelDrawings drawings, XmlNode node, eChartType type, ExcelChart topChart,
    ...
    internal ExcelSurfaceChart(ExcelDrawings drawings, XmlNode node, Uri uriChart, ZipPackagePart part,
    ...
    private void Init()
    {
        Floor = new ExcelChartSurface(NameSpaceManager,
            _chartXmlHelper.TopNode.SelectSingleNode("c:floor", NameSpaceManager));
        BackWall = new ExcelChartSurface(NameSpaceManager,
            _chartXmlHelper.TopNode.SelectSingleNode("c:sideWall", NameSpaceManager));
        SideWall = new ExcelChartSurface(NameSpaceManager,
            _chartXmlHelper.TopNode.SelectSingleNode("c:backWall", NameSpaceManager));
        SetTypeProperties();
    }
