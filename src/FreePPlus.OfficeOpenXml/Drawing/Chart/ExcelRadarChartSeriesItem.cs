...
/// </summary>
public sealed class ExcelRadarChartSeriesItem : ExcelChartSeriesItem
{
    ...
    internal ExcelRadarChartSeriesItem(ExcelChartSeries chartSeries, XmlNamespaceManager ns, XmlNode node,
        bool isPivot) :
        base(chartSeries, ns, node, isPivot)
    {
        if (chartSeries.Chart.ChartType == eChartType.Radar) Marker = eMarkerStyle.None;
    }
