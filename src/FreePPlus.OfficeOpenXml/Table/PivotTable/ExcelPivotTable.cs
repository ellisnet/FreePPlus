...
public class ExcelPivotTable : XmlHelper
{
    ...
    internal ExcelPivotTable(ExcelWorksheet sheet, ExcelAddressBase address, ExcelRangeBase sourceAddress, string name,
        int tblId) :
        base(sheet.NameSpaceManager)
    {
        WorkSheet = sheet;
        ...
        Relationship = sheet.Part.CreateRelationship(UriHelper.ResolvePartUri(sheet.WorksheetUri, PivotTableUri),
        ...
        _cacheDefinition.Relationship = Part.CreateRelationship(
            UriHelper.ResolvePartUri(PivotTableUri, _cacheDefinition.CacheDefinitionUri), TargetMode.Internal,
    ...
    public string Name
    {
        ...
        set
        {
            if (WorkSheet.Workbook.ExistsTableName(value)) throw new ArgumentException("PivotTable name is not unique");
            var prevName = Name;
    ...
    private void init()
    {
        SchemaNodeOrder = new[]
        {
            "location", "pivotFields", "rowFields", "rowItems", "colFields", "colItems", "pageFields", "pageItems",
            "dataFields", "dataItems", "formats", "pivotTableStyleInfo"
        };
    }
    ...
    private void LoadFields()
    {
        ...
        //Add fields.
        index = 0;
        foreach (XmlElement fieldElem in _cacheDefinition.TopNode.SelectNodes("d:cacheFields/d:cacheField",
                     NameSpaceManager))
        {
    ...
    private string GetStartXml(string name, int id, ExcelAddressBase address, ExcelAddressBase sourceAddress)
    {
        var xml = string.Format(
            ...
            ConvertUtil.ExcelEscapeString(name), id);

        xml += string.Format("<location ref=\"{0}\" firstHeaderRow=\"1\" firstDataRow=\"1\" firstDataCol=\"1\" /> ",
    ...
    public int PageWrap
    {
        ...
        set
        {
            if (value < 0) throw new Exception("Value can't be negative");
    ...
    /// <summary>
    ///     A boolean that indicates whether the in-grid drop zones should be displayed at runtime, and whether classic layout
    ///     is applied
    /// </summary>
    ...
    /// <summary>
    ///     A boolean that indicates whether the field next to the data field in the PivotTable should be displayed in the same
    ...
    public ExcelPivotTableFieldCollection Fields
    {
        get
        {
            if (_fields == null) _fields = new ExcelPivotTableFieldCollection(this, "");
            return _fields;
        }
    }
    ...
    public ExcelPivotTableRowColumnFieldCollection RowFields
    {
        get
        {
            if (_rowFields == null) _rowFields = new ExcelPivotTableRowColumnFieldCollection(this, "rowFields");
            return _rowFields;
        }
    }
    ...
    public ExcelPivotTableRowColumnFieldCollection ColumnFields
    {
        get
        {
            if (_columnFields == null) _columnFields = new ExcelPivotTableRowColumnFieldCollection(this, "colFields");
    ...
    public ExcelPivotTableDataFieldCollection DataFields
    {
        get
        {
            if (_dataFields == null) _dataFields = new ExcelPivotTableDataFieldCollection(this);
            return _dataFields;
        }
    }
    ...
    public ExcelPivotTableRowColumnFieldCollection PageFields
    {
        get
        {
            if (_pageFields == null) _pageFields = new ExcelPivotTableRowColumnFieldCollection(this, "pageFields");
            return _pageFields;
        }
    }
    ...
    public string StyleName
    {
        ...
        set
        {
            if (value.StartsWith("PivotStyle"))
            {
                try
                {
                    _tableStyle = (TableStyles)Enum.Parse(typeof(TableStyles), value.Substring(10, value.Length - 10),
                        true);
                }
                catch
                {
    ...
    public TableStyles TableStyle
    {
        ...
        {
            _tableStyle = value;
            if (value != TableStyles.Custom) SetXmlNodeString(STYLENAME_PATH, "PivotStyle" + value);
        }
    }
