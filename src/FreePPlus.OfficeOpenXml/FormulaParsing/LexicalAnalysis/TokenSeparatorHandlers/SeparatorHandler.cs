...
public abstract class SeparatorHandler
{
    ...
    {
        return tokenSeparator.TokenType == TokenType.String && formulaCharIndex + 1 < context.FormulaChars.Length &&
               context.FormulaChars[formulaCharIndex + 1] == '\"';
    }

    public abstract bool Handle(char c, Token tokenSeparator, TokenizerContext context,
