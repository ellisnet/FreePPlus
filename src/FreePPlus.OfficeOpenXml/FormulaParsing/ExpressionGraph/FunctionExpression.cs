...
public class FunctionExpression : AtomicExpression
{
        ...
        : base(expression)
    {
        ...
        _functionCompilerFactory =
            new FunctionCompilerFactory(parsingContext.Configuration.FunctionRepository, parsingContext);
    ...
    public override CompileResult Compile()
    {
        try
        {
            ...
            if (function == null)
            {
                if (_parsingContext.Debug)
                    _parsingContext.Configuration.Logger.Log(_parsingContext,
            ...
            if (_parsingContext.Debug) _parsingContext.Configuration.Logger.LogFunction(ExpressionString);
        ...
        {
            if (_parsingContext.Debug) _parsingContext.Configuration.Logger.Log(_parsingContext, e);
