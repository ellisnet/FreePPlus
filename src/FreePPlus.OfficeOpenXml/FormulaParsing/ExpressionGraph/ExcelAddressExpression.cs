...
public class ExcelAddressExpression : AtomicExpression
{
    ...
    public ExcelAddressExpression(string expression, ExcelDataProvider excelDataProvider, ParsingContext parsingContext,
        RangeAddressFactory rangeAddressFactory, bool negate)
        : base(expression)
    {
    ...
    ///     <see cref="ExcelDataProvider.IRangeInfo" />
    /// </summary>
    ...
    private CompileResult CompileRangeValues()
    {
        ...
        var result =
            _excelDataProvider.GetRange(c.Address.Worksheet, c.Address.FromRow, c.Address.FromCol, ExpressionString);
