...
public class LookupArguments
{
        ...
        ParsingContext context)
    {
        ...
        if (indexVal.DataType == DataType.ExcelAddress)
        {
            ...
            var indexObj =
                context.ExcelDataProvider.GetRangeValue(address.WorkSheet, address._fromRow, address._fromCol);
    ...
    public LookupArguments(object searchedValue, string rangeAddress, int lookupIndex, int lookupOffset,
        bool rangeLookup, ExcelDataProvider.IRangeInfo rangeInfo)
    {
