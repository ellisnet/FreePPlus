...
public class IsError : ErrorHandlingFunction
{
    ...
    {
        if (arguments == null || arguments.Count() == 0) return CreateResult(false, DataType.Boolean);
        foreach (var argument in arguments)
            ...
            {
                if (ExcelErrorValue.Values.IsErrorValue(argument.Value)) return CreateResult(true, DataType.Boolean);
            }
