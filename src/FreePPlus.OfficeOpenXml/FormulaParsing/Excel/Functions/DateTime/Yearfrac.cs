...
public class Yearfrac : ExcelFunction
{
    public override CompileResult Execute(IEnumerable<FunctionArgument> arguments, ParsingContext context)
    {
        ...
        switch (basis)
        {
            ...
            case 1:
                return CreateResult(System.Math.Abs((date2 - date1).TotalDays / CalculateAcutalYear(date1, date2)),
                    DataType.Decimal);
            case 2:
    ...
    private double CalculateAcutalYear(System.DateTime dt1, System.DateTime dt2)
    {
        ...
        for (var y = dt1.Year; y <= dt2.Year; ++y) perYear += calendar.IsLeapYear(y) ? 366 : 365;
