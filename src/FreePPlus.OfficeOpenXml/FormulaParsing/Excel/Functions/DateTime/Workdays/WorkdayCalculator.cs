...
public class WorkdayCalculator
{
    ...
    public WorkdayCalculatorResult CalculateNumberOfWorkdays(System.DateTime startDate, System.DateTime endDate)
    {
        ...
        if (!_holidayWeekdays.IsHolidayWeekday(calcStartDate)) workdaysCounted++;
        ...
        FunctionArgument holidayArgument)
    {
        ...
        return new WorkdayCalculatorResult(calculatedResult.NumberOfWorkdays - nAdditionalHolidayDays, startDate,
            endDate, calculatedResult.Direction);
    }
