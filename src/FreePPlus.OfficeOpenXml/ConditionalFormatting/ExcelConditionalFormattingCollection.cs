...
/// <remarks>
///     <para>
///         The public methods of this class (Add[...]ConditionalFormatting) will create a ConditionalFormatting/CfRule
///         entry in the worksheet. When this
        ...
        IEnumerable<IExcelConditionalFormattingRule>
{
            ...
            worksheet.WorksheetXml.DocumentElement)
    {
        ...
        if (conditionalFormattingNodes != null
            ...
            foreach (XmlNode conditionalFormattingNode in conditionalFormattingNodes)
            {
                ...
                if (conditionalFormattingNode?.Attributes?[ExcelConditionalFormattingConstants.Attributes.Sqref] ==
                    null)
                    throw new Exception(
    ...
    public IExcelConditionalFormattingThreeIconSet<eExcelconditionalFormatting3IconsSetType> AddThreeIconSet(
        ExcelAddress address, eExcelconditionalFormatting3IconsSetType iconSet)
    {
    ...
    public IExcelConditionalFormattingFourIconSet<eExcelconditionalFormatting4IconsSetType> AddFourIconSet(
        ExcelAddress address, eExcelconditionalFormatting4IconsSetType iconSet)
    {
    ...
    /// <param name="iconSet"></param>
    /// <returns></returns>
    public IExcelConditionalFormattingFiveIconSet AddFiveIconSet(ExcelAddress address,
