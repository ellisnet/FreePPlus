    ...
    : XmlHelper
{
    ...
    public eExcelConditionalFormattingValueObjectType Type
    {
        ...
        set
        {
            if ((RuleType == eExcelConditionalFormattingRuleType.ThreeIconSet ||
                 RuleType == eExcelConditionalFormattingRuleType.FourIconSet ||
                 RuleType == eExcelConditionalFormattingRuleType.FiveIconSet) &&
            ...
            SetXmlNodeString(ExcelConditionalFormattingConstants.Paths.TypeAttribute,
    ...
    public string Formula
    {
        get
        {
            ...
            if (Type != eExcelConditionalFormattingValueObjectType.Formula) return string.Empty;
