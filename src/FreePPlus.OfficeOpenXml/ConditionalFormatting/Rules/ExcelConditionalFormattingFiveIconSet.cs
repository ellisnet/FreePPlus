        ...
        IExcelConditionalFormattingFiveIconSet
{
            ...
            namespaceManager == null ? worksheet.NameSpaceManager : namespaceManager)
    {
        ...
        else
        {
            ...
            var iconNode4 = iconSetNode?.OwnerDocument?.CreateElement(ExcelConditionalFormattingConstants.Paths.Cfvo,
                ExcelPackage.SchemaMain);
            if (iconNode4 != null) iconSetNode.AppendChild(iconNode4);
            ...
            var iconNode5 = iconSetNode?.OwnerDocument?.CreateElement(ExcelConditionalFormattingConstants.Paths.Cfvo,
                ExcelPackage.SchemaMain);
            if (iconNode5 != null) iconSetNode.AppendChild(iconNode5);
