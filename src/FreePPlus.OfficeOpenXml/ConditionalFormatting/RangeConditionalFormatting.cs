...
{
    private readonly ExcelAddress _address;
    ...
    {
        var rule =
            (IExcelConditionalFormattingThreeIconSet<eExcelconditionalFormatting3IconsSetType>)_worksheet
    ...
    {
        var rule =
            (IExcelConditionalFormattingFourIconSet<eExcelconditionalFormatting4IconsSetType>)_worksheet
                .ConditionalFormatting.AddRule(
