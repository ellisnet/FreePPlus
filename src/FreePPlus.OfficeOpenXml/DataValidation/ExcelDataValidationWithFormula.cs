    ...
    where T : IExcelDataValidationFormula
{
    ...
    internal ExcelDataValidationWithFormula(ExcelWorksheet worksheet, string address,
    ...
    internal ExcelDataValidationWithFormula(ExcelWorksheet worksheet, string address,
        ExcelDataValidationType validationType, XmlNode itemElementNode)
    ...
    internal ExcelDataValidationWithFormula(ExcelWorksheet worksheet, string address,
        ExcelDataValidationType validationType, XmlNode itemElementNode, XmlNamespaceManager namespaceManager)
    ...
    {
        base.Validate();
        if (ValidationType != ExcelDataValidationType.List && (Operator == ExcelDataValidationOperator.between ||
                                                               Operator == ExcelDataValidationOperator.notBetween))
            if (string.IsNullOrEmpty(Formula2Internal))
                throw new InvalidOperationException("Validation of " + Address.Address +
