...
public partial class ArrayPoolMemoryAllocator
{
    ...
    /// <summary>
    ///     The value for: The threshold to pool arrays in <see cref="largeArrayPool" /> which has less buckets for memory
    ///     safety.
    /// </summary>
    ...
    /// <summary>
    ///     For environments with limited memory capabilities, only small array requests are pooled, which can result in
    ///     reduced throughput.
    /// </summary>
    /// <returns>The memory manager.</returns>
    ...
    /// <summary>
    ///     For environments where memory capabilities are not an issue, the maximum amount of array requests are pooled which
