...
public abstract partial class Image
{
    ...
    {
        return Identify(data, out var _);
    }
    ...
    {
        return Identify(Configuration.Default, data, out format);
    }
    ...
    {
        return Load<Rgba32>(Configuration.Default, data);
    }
    ...
    {
        return Load<TPixel>(Configuration.Default, data);
    }
    ...
    public static Image<TPixel> Load<TPixel>(byte[] data, out IImageFormat format)
        where TPixel : unmanaged, IPixel<TPixel>
    {
        return Load<TPixel>(Configuration.Default, data, out format);
    }
    ...
    public static IImageFormat DetectFormat(Configuration configuration, ReadOnlySpan<byte> data)
    {
        ...
        if (maxHeaderSize <= 0) return null;
    ...
    public static Image<TPixel> Load<TPixel>(ReadOnlySpan<byte> data, IImageDecoder decoder)
        where TPixel : unmanaged, IPixel<TPixel>
    {
        return Load<TPixel>(Configuration.Default, data, decoder);
    }
    ...
    {
        return Load(Configuration.Default, data, out format);
    }
    ...
    {
        return Load(Configuration.Default, data, decoder);
    }
    ...
    {
        return Load(configuration, data, out _);
    }
    ...
    {
        return Load(Configuration.Default, data);
    }
