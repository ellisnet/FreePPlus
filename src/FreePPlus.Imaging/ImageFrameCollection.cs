...
public abstract class ImageFrameCollection : IEnumerable<ImageFrame>
{
    ...
    public abstract IImageFormat Format { get; }

    /// <summary>
    ///     Gets the root frame.
    /// </summary>
    public ImageFrame RootFrame => NonGenericRootFrame;
    ...
    public ImageFrame this[int index] => NonGenericGetFrame(index);
    ...
    /// <summary>
    ///     Clones and inserts the <paramref name="source" /> into the <seealso cref="ImageFrameCollection" /> at the specified
    ///     <paramref name="index" />.
    /// </summary>
    /// <param name="index">The zero-based index to insert the frame at.</param>
    /// <param name="source">
    ///     The <seealso cref="ImageFrame" /> to clone and insert into the
    ///     <seealso cref="ImageFrameCollection" />.
    /// </param>
