...
internal static partial class DebugGuard
{
    ...
    public static void NotNull<TValue>(TValue value, string parameterName)
        where TValue : class
    {
        if (value is null) ThrowArgumentNullException(parameterName);
    }
    ...
    public static void NotNullOrWhiteSpace(string value, string parameterName)
    {
        ...
        if (string.IsNullOrWhiteSpace(value)) ThrowArgumentException("Must not be empty or whitespace.", parameterName);
    }
    ...
    {
        if (!target) ThrowArgumentException(message, parameterName);
    }
    ...
    {
        if (source.Length < minLength) ThrowArgumentException($"The size must be at least {minLength}.", parameterName);
    }
