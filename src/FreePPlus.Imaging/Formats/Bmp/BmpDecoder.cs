...
{
    /// <summary>
    ///     Gets or sets a value indicating how to deal with skipped pixels, which can occur during decoding run length encoded
    ///     bitmaps.
    /// </summary>
        ...
        where TPixel : unmanaged, IPixel<TPixel>
    {
        ...
        catch (InvalidMemoryOperationException ex)
        {
            ...
            throw new InvalidImageContentException(
                $"Can not decode image. Failed to allocate buffers for possibly degenerate dimensions: {dims.Width}x{dims.Height}. This error can happen for very large RLE bitmaps, which are not supported.",
                ex);
        }
    }
