...
internal unsafe struct ZigZag
{
    ...
    public byte this[int idx]
    {
        ...
        get
        {
            ref var self = ref Unsafe.As<ZigZag, byte>(ref this);
    ...
    public static ZigZag CreateUnzigTable()
    {
        ...
        ref var sourceRef = ref MemoryMarshal.GetReference(Unzig);
        ref var destinationRef = ref Unsafe.AsRef<byte>(result.Data);
    ...
    public static Block8x8F CreateDequantizationTable(ref Block8x8F qt)
    {
        ...
        for (var i = 0; i < Block8x8F.Size; i++) result[Unzig[i]] = qt[i];
