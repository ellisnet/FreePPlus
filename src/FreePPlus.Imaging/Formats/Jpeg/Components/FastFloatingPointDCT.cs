...
{
    private static readonly Vector4 InvSqrt2 = new(0.707107f);

    /// <summary>
    ///     Apply floating point IDCT transformation into dest, using a temporary block 'temp' provided by the caller
    ///     (optimization).
    ...
    public static void IDCT8x4_LeftPart(ref Block8x8F s, ref Block8x8F d)
    {
        ...
        var mb3 = my7 * C_0_298631 + mz0 + mz2;
        var mb2 = my5 * C_2_053120 + mz1 + mz3;
        var mb1 = my3 * C_3_072711 + mz1 + mz2;
        var mb0 = my1 * C_1_501321 + mz0 + mz3;
    ...
    {
        src.TransposeInto(ref temp);
        if (offsetSourceByNeg128) temp.AddToAllInplace(new Vector4(-128));
