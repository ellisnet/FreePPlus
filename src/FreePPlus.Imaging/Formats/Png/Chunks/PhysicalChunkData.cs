...
namespace FreePPlus.Imaging.Formats.Png.Chunks;

//was previously: namespace SixLabors.ImageSharp.Formats.Png.Chunks;
...
internal readonly struct PhysicalChunkData
{
    ...
    ///     0: unit is unknown
    ///     1: unit is the meter
    ///     When the unit specifier is 0, the pHYs chunk defines pixel aspect ratio only; the actual size of the pixels remains
    ///     unspecified.
    /// </summary>
