...
internal static class DeflateThrowHelper
{
    ...
    {
        throw new InvalidOperationException("Deflator already closed.");
    }

    [MethodImpl(InliningOptions.ColdPath)]
    public static void ThrowUnknownCompression()
    {
        throw new InvalidOperationException("Unknown compression function.");
    }
    ...
    {
        throw new InvalidOperationException("Huffman heap invariant violated.");
    }

    [MethodImpl(InliningOptions.ColdPath)]
    public static void ThrowNoDeflate()
    {
        throw new ImageFormatException("Cannot deflate all input.");
    }
}