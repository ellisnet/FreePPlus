...
internal static partial class Vector4Converters
{
    ...
    ///     The method is works by internally converting to a <see cref="Rgba32" /> therefore it's not applicable for that
    ///     type!
    /// </summary>
    public static class RgbaCompatible
    {
        ...
        ///     <see
        ///         cref="PixelOperations{TPixel}.ToVector4(SixLabors.ImageSharp.Configuration,System.ReadOnlySpan{TPixel},System.Span{System.Numerics.Vector4},SixLabors.ImageSharp.PixelFormats.PixelConversionModifiers)" />
            ...
            where TPixel : unmanaged, IPixel<TPixel>
        {
            ...
            var lastQuarterOfDestBuffer = MemoryMarshal.Cast<Vector4, Rgba32>(destVectors)
                .Slice(3 * count + 1, countWithoutLastItem);
        ...
        ///     Provides an efficient default implementation for
        ///     <see
        ///         cref="PixelOperations{TPixel}.FromVector4Destructive(SixLabors.ImageSharp.Configuration,System.Span{System.Numerics.Vector4},System.Span{TPixel},SixLabors.ImageSharp.PixelFormats.PixelConversionModifiers)" />
        ///     The method is works by internally converting to a <see cref="Rgba32" /> therefore it's not applicable for that
        ///     type!
        /// </summary>
        [MethodImpl(InliningOptions.ShortMethod)]
        ...
        {
            if (!Vector.IsHardwareAccelerated) return int.MaxValue;
