...
public struct A8 : IPixel<A8>, IPackedVector<byte>
{
    ...
    {
        return new Vector4(0, 0, 0, PackedValue / 255F);
    }
    ...
    {
        PackedValue = ImageMaths.DownScaleFrom16BitTo8Bit(source.A);
    }
    ...
    {
        return obj is A8 other && Equals(other);
    }
    ...
    {
        return (byte)Math.Round(alpha.Clamp(0, 1F) * 255F);
    }
}