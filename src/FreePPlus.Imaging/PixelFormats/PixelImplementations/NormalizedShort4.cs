...
{
    private static readonly Vector4 Max = new(0x7FFF);
    ...
    {
        return new PixelOperations<NormalizedShort4>();
    }
    ...
    public readonly override string ToString()
    {
        ...
        return FormattableString.Invariant(
            $"NormalizedShort4({vector.X:#0.##}, {vector.Y:#0.##}, {vector.Z:#0.##}, {vector.W:#0.##})");
    }
    ...
    private static ulong Pack(ref Vector4 vector)
    {
        ...
        var word4 = ((ulong)MathF.Round(vector.X) & 0xFFFF) << 0x00;
        var word3 = ((ulong)MathF.Round(vector.Y) & 0xFFFF) << 0x10;
        var word2 = ((ulong)MathF.Round(vector.Z) & 0xFFFF) << 0x20;
        var word1 = ((ulong)MathF.Round(vector.W) & 0xFFFF) << 0x30;
