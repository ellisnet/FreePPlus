...
public struct Short4 : IPixel<Short4>, IPackedVector<ulong>
{
    ...
    {
        return new PixelOperations<Short4>();
    }
    ...
    public readonly override string ToString()
    {
        ...
        return FormattableString.Invariant(
            $"Short4({vector.X:#0.##}, {vector.Y:#0.##}, {vector.Z:#0.##}, {vector.W:#0.##})");
    }
    ...
    private static ulong Pack(ref Vector4 vector)
    {
        ...
        var word4 = ((ulong)Math.Round(vector.X) & 0xFFFF) << 0x00;
        var word3 = ((ulong)Math.Round(vector.Y) & 0xFFFF) << 0x10;
        var word2 = ((ulong)Math.Round(vector.Z) & 0xFFFF) << 0x20;
        var word1 = ((ulong)Math.Round(vector.W) & 0xFFFF) << 0x30;
