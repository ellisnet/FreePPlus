...
using FreePPlus.Imaging.PixelFormats.PixelBlenders;
    ...
    where TPixel : unmanaged, IPixel<TPixel>
{
    ...
    /// <returns>A <see cref="PixelBlender{TPixel}" />.</returns>
    public virtual PixelBlender<TPixel> GetPixelBlender(PixelColorBlendingMode colorMode,
        ...
        switch (alphaMode)
        {
            ...
            case PixelAlphaCompositionMode.SrcAtop:
                switch (colorMode)
                {
                    ...
                    case PixelColorBlendingMode.HardLight:
                        return DefaultPixelBlenders<TPixel>.HardLightSrcAtop.Instance;
                    case PixelColorBlendingMode.Normal:
            ...
            case PixelAlphaCompositionMode.DestAtop:
                switch (colorMode)
                {
                    ...
                    case PixelColorBlendingMode.HardLight:
                        return DefaultPixelBlenders<TPixel>.HardLightDestAtop.Instance;
                    case PixelColorBlendingMode.Normal:
            ...
            case PixelAlphaCompositionMode.DestOut:
                switch (colorMode)
                {
                    ...
                    case PixelColorBlendingMode.HardLight:
                        return DefaultPixelBlenders<TPixel>.HardLightDestOut.Instance;
                    case PixelColorBlendingMode.Normal:
            ...
            case PixelAlphaCompositionMode.DestOver:
                switch (colorMode)
                {
                    ...
                    case PixelColorBlendingMode.HardLight:
                        return DefaultPixelBlenders<TPixel>.HardLightDestOver.Instance;
                    case PixelColorBlendingMode.Normal:
            ...
            default:
                switch (colorMode)
                {
                    ...
                    case PixelColorBlendingMode.HardLight:
                        return DefaultPixelBlenders<TPixel>.HardLightSrcOver.Instance;
                    case PixelColorBlendingMode.Normal:
