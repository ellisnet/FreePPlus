...
public enum IccProfileTag : uint
{
    ...
    /// <summary>
    ///     A2B2 - This tag describes the color transform from Device or Color Encoding to PCS using lookup table tag element
    ///     structures
    /// </summary>
    AToB1 = 0x41324231,
    ...
    /// <summary>
    ///     bTRC - This tag contains the blue channel tone reproduction curve. The first element represents no colorant (white)
    ///     or
    ...
    /// <summary>
    ///     B2A0 - This tag defines a color transform from PCS to Device or Color Encoding using the lookup table tag element
    ///     structures
    /// </summary>
    BToA0 = 0x42324130,

    /// <summary>
    ///     B2A1 - This tag defines a color transform from PCS to Device or Color Encoding using the lookup table tag element
    ///     structures.
    /// </summary>
    BToA1 = 0x42324131,

    /// <summary>
    ///     B2A2 - This tag defines a color transform from PCS to Device or Color Encoding using the lookup table tag element
    ///     structures.
    /// </summary>
    BToA2 = 0x42324132,

    /// <summary>
    ///     B2D0 - This tag defines a color transform from PCS to Device. It supports float32Number-encoded input range, output
    ///     range and transform, and
    ///     provides a means to override the BToA0 tag.
    /// </summary>
    BToD0 = 0x42324430,

    /// <summary>
    ///     B2D1 - This tag defines a color transform from PCS to Device. It supports float32Number-encoded input range, output
    ///     range and transform, and
    ...
    /// <summary>
    ///     B2D2 - This tag defines a color transform from PCS to Device. It supports float32Number-encoded input range, output
    ///     range and transform, and
    ...
    /// <summary>
    ///     B2D3 - This tag defines a color transform from PCS to Device. It supports float32Number-encoded input range, output
    ///     range and transform, and
    ///     provides a means to override the BToA1 tag.
    /// </summary>
    BToD3 = 0x42324433,
    ...
    /// <summary>
    ///     calt - This tag contains the profile calibration date and time. This allows applications and utilities to verify if
    ///     this profile matches a
    ...
    /// <summary>
    ///     chad - This tag contains a matrix, which shall be invertible, and which converts an nCIEXYZ color, measured using
    ...
    ///     colorant (white) or phosphor (black) and the last element represents 100 % colorant (green) or 100 % phosphor
    ///     (green).
    /// </summary>
    GreenTrc = 0x67545243,

    /// <summary>
    ///     lumi - This tag contains the absolute luminance of emissive devices in candelas per square meter as described by
    ///     the Y channel.
    /// </summary>
    Luminance = 0x6C756d69,

    /// <summary>
    ///     meas - This tag describes the alternative measurement specification, such as a D65 illuminant instead of the
    ///     default D50.
    /// </summary>
    ...
    /// <summary>
    ///     resp - This tag describes the structure containing a description of the device response for which the profile is
    ///     intended.
    /// </summary>
