...
internal sealed class IccParametricCurve : IEquatable<IccParametricCurve>
{
    ...
    private IccParametricCurve(IccParametricCurveType type, float g, float a, float b, float c, float d, float e,
        float f)
    {
        Type = type;
        G = g;
    ...
    {
        return obj is IccParametricCurve other && Equals(other);
    }
