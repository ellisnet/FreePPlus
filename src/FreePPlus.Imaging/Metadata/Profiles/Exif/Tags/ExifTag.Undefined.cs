...
public abstract partial class ExifTag
{
    ...
    /// </summary>
    public static ExifTag<byte[]> UserComment { get; } = new(ExifTagValue.UserComment);
    ...
    /// </summary>
    public static ExifTag<byte[]> GPSProcessingMethod { get; } = new(ExifTagValue.GPSProcessingMethod);

    /// <summary>
    ///     Gets the GPSAreaInformation exif tag.
    /// </summary>
    public static ExifTag<byte[]> GPSAreaInformation { get; } = new(ExifTagValue.GPSAreaInformation);
