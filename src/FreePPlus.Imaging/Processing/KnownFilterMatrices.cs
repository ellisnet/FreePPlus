...
public static class KnownFilterMatrices
{
    ...
    ///     Other values are linear multipliers on the effect. Values of an amount over 1 are allowed, providing brighter
    ///     results.
    /// </remarks>
    ...
    ///     Other values are linear multipliers on the effect. Values of an amount over 1 are allowed, providing results with
    ///     more contrast.
    /// </remarks>
    /// <param name="amount">The proportion of the conversion. Must be greater than or equal to 0.</param>
    /// <returns>The <see cref="ColorMatrix" /></returns>
    ...
    /// <summary>
    ///     Create a grayscale filter matrix using the given amount using the formula as specified by ITU-R Recommendation
    ///     BT.601.
