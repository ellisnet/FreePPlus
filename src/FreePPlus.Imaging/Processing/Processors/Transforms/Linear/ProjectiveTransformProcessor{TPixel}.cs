    ...
    where TPixel : unmanaged, IPixel<TPixel>
{
    ...
    public ProjectiveTransformProcessor(Configuration configuration, ProjectiveTransformProcessor definition,
    ...
    private readonly struct NNProjectiveOperation : IRowOperation
    {
        ...
        public void Invoke(int y)
        {
            ...
            {
                var point = TransformUtilities.ProjectiveTransform2D(x, y, matrix);
