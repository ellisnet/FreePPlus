...
public readonly struct CubicResampler : IResampler
{
    ...
    /// </summary>
    public static CubicResampler CatmullRom = new(2, 0, .5F);
    ...
    /// </summary>
    public static CubicResampler Hermite = new(2, 0, 0);
    ...
    /// </summary>
    public static CubicResampler MitchellNetravali = new(2, .3333333F, .3333333F);

    /// <summary>
    ///     The function implements the Robidoux algorithm.
    ///     <see href="http://www.imagemagick.org/Usage/filter/#robidoux" />
    /// </summary>
    public static CubicResampler Robidoux = new(2, .37821575509399867F, .31089212245300067F);

    /// <summary>
    ///     The function implements the Robidoux Sharp algorithm.
    ///     <see href="http://www.imagemagick.org/Usage/filter/#robidoux" />
    /// </summary>
    public static CubicResampler RobidouxSharp = new(2, .2620145123990142F, .3689927438004929F);
    ...
    ///     <see href="http://www.imagemagick.org/Usage/filter/#robidoux" />
    /// </summary>
    public static CubicResampler Spline = new(2, 1, 0);
