...
public static class KnownResamplers
{
    ...
    /// <summary>
    ///     Gets the Nearest-Neighbour sampler that implements the nearest neighbor algorithm. This uses a very fast, unscaled
    ///     filter
    ...
    /// <summary>
    ///     Gets the Spline sampler. A separable cubic algorithm similar to <see cref="MitchellNetravali" /> but yielding
    ///     smoother results.
    /// </summary>
    public static IResampler Spline { get; } = CubicResampler.Spline;

    /// <summary>
    ///     Gets the Triangle sampler, otherwise known as Bilinear. This interpolation algorithm can be used where perfect
