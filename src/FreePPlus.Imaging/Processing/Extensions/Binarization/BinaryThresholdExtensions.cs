...
public static class BinaryThresholdExtensions
{
    ...
    {
        return source.ApplyProcessor(new BinaryThresholdProcessor(threshold));
    }
    ...
    public static IImageProcessingContext BinaryThreshold(
        ...
        Rectangle rectangle)
    {
        return source.ApplyProcessor(new BinaryThresholdProcessor(threshold), rectangle);
    }
    ...
    public static IImageProcessingContext BinaryThreshold(
        ...
        Color lowerColor)
    {
        return source.ApplyProcessor(new BinaryThresholdProcessor(threshold, upperColor, lowerColor));
    }
    ...
    public static IImageProcessingContext BinaryThreshold(
        ...
        Rectangle rectangle)
    {
        return source.ApplyProcessor(new BinaryThresholdProcessor(threshold, upperColor, lowerColor), rectangle);
    }
}