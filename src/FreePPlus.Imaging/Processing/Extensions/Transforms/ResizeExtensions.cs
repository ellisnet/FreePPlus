...
public static class ResizeExtensions
{
    ...
    /// <param name="size">The target image size.</param>
    /// <param name="compand">
    ///     Whether to compress and expand the image color-space to gamma correct the image during
    ///     processing.
    /// </param>
    /// <returns>The <see cref="IImageProcessingContext" /> to allow chaining of operations.</returns>
    /// <remarks>
    ...
    ///     the nearest possible ratio.
    /// </remarks>
    public static IImageProcessingContext Resize(this IImageProcessingContext source, Size size, IResampler sampler,
        bool compand)
    {
    ...
    /// </remarks>
    public static IImageProcessingContext Resize(this IImageProcessingContext source, int width, int height,
        IResampler sampler, bool compand)
    {
    ...
    /// <returns>The <see cref="IImageProcessingContext" /> to allow chaining of operations.</returns>
    /// <remarks>
    ///     Passing zero for one of height or width within the resize options will automatically preserve the aspect ratio
    ///     of the original image or the nearest possible ratio.
    /// </remarks>
