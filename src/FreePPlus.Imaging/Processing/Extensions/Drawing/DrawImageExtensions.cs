...
using FreePPlus.Imaging.Processing.Processors.Drawing;
...
public static class DrawImageExtensions
{
    ...
    public static IImageProcessingContext DrawImage(
        ...
        float opacity)
    {
        return source.ApplyProcessor(new DrawImageProcessor(image, Point.Empty, colorBlending, alphaComposition,
            opacity));
    }
    ...
    public static IImageProcessingContext DrawImage(
        ...
        float opacity)
    {
        return source.ApplyProcessor(new DrawImageProcessor(image, location, colorBlending, alphaComposition, opacity));
    }
