...
public static class DetectEdgesExtensions
{
    ...
    {
        return DetectEdges(source, new SobelProcessor(true));
    }
    ...
    {
        return DetectEdges(source, rectangle, new SobelProcessor(true));
    }
    ...
    {
        return DetectEdges(source, GetProcessor(filter, true));
    }
    ...
    public static IImageProcessingContext DetectEdges(
        ...
        bool grayscale)
    {
        return DetectEdges(source, GetProcessor(filter, grayscale));
    }
    ...
    public static IImageProcessingContext DetectEdges(
        ...
        bool grayscale = true)
    {
        return DetectEdges(source, rectangle, GetProcessor(filter, grayscale));
    }
