...
/// <summary>
///     Represents a linear Rgb color with specified <see cref="RgbWorkingSpace" /> working space
/// </summary>
public readonly struct LinearRgb : IEquatable<LinearRgb>
{
    ...
    {
        return FormattableString.Invariant($"LinearRgb({R:#0.##}, {G:#0.##}, {B:#0.##})");
    }

    /// <inheritdoc />
    public override bool Equals(object obj)
    {
        return obj is LinearRgb other && Equals(other);
    }
