...
public class ColorSpaceConverterOptions
{
    ...
    ///     When
    ///     <value>default</value>
    ///     - no adaptation will be performed.
    ///     Defaults to: <see cref="CieLuv.DefaultWhitePoint" />.
    /// </summary>
    public CieXyz WhitePoint { get; set; } = CieLuv.DefaultWhitePoint;

    /// <summary>
    ///     Gets or sets the white point used *when creating* Luv/LChuv colors. (Luv/LChuv colors on the input already contain
    ///     the white point information)
    ///     Defaults to: <see cref="CieLuv.DefaultWhitePoint" />.
    /// </summary>
    public CieXyz TargetLuvWhitePoint { get; set; } = CieLuv.DefaultWhitePoint;

    /// <summary>
    ///     Gets or sets the white point used *when creating* Lab/LChab colors. (Lab/LChab colors on the input already contain
    ///     the white point information)
    ...
    /// <summary>
    ///     Gets or sets the white point used *when creating* HunterLab colors. (HunterLab colors on the input already contain
    ///     the white point information)
    ...
    /// <summary>
    ///     Gets or sets the target working space used *when creating* RGB colors. (RGB colors on the input already contain the
