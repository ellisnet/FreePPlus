...
internal sealed class CieXyzAndLmsConverter
{
    ...
    public CieXyzAndLmsConverter(Matrix4x4 transformationMatrix)
    {
        ...
        Matrix4x4.Invert(_transformationMatrix, out _inverseTransformationMatrix);
    }
    ...
    {
        var vector = Vector3.Transform(input.ToVector3(), _transformationMatrix);
    ...
    {
        var vector = Vector3.Transform(input.ToVector3(), _inverseTransformationMatrix);
