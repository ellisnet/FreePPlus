...
public static class Rec2020Companding
{
    ...
    {
        return channel < InverseBeta ? channel / 4.5F : MathF.Pow((channel + AlphaMinusOne) / Alpha, Epsilon);
    }
    ...
    {
        return channel < Beta ? 4.5F * channel : Alpha * MathF.Pow(channel, 0.45F) - AlphaMinusOne;
    }
}