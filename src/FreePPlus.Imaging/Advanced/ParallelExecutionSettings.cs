...
public readonly struct ParallelExecutionSettings
{
    ...
    ///     <see cref="ParallelOptions.MaxDegreeOfParallelism" /> when using TPL.
    /// </param>
    ...
    public ParallelExecutionSettings MultiplyMinimumPixelsPerTask(int multiplier)
    {
        ...
        return new ParallelExecutionSettings(
            ...
            MinimumPixelsProcessedPerTask * multiplier,
            MemoryAllocator);
    }

    /// <summary>
    ///     Get the default <see cref="SixLabors.ImageSharp.Advanced.ParallelExecutionSettings" /> for a
    ///     <see cref="SixLabors.ImageSharp.Configuration" />
    /// </summary>
