...
public struct Point : IEquatable<Point>
{
    ...
    {
        return new Point(unchecked(point.X * value), unchecked(point.Y * value));
    }
    ...
    /// <summary>
    ///     Converts a <see cref="PointF" /> to a <see cref="Point" /> by performing a ceiling operation on all the
    ///     coordinates.
    /// </summary>
    /// <param name="point">The point.</param>
    /// <returns>The <see cref="Point" />.</returns>
    ...
    {
        return new Point(unchecked((int)MathF.Round(vector.X)), unchecked((int)MathF.Round(vector.Y)));
    }

    /// <summary>
    ///     Converts a <see cref="PointF" /> to a <see cref="Point" /> by performing a truncate operation on all the
    ///     coordinates.
    /// </summary>
    /// <param name="point">The point.</param>
    /// <returns>The <see cref="Point" />.</returns>
    ...
    {
        return unchecked((short)((n >> 16) & 0xffff));
    }

    private static short LowInt16(int n)
    {
        return unchecked((short)(n & 0xffff));
    }
}