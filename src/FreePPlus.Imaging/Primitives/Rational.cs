...
public readonly struct Rational : IEquatable<Rational>
{
    ...
    ///     The number above the line in a vulgar fraction showing how many of the parts indicated by the
    ...
    {
        var left = new LongRational(Numerator, Denominator);
    ...
    {
        var self = new LongRational(Numerator, Denominator);
